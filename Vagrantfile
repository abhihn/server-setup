...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "kpvarma-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/qwinix-learning"
  #   chef.validation_client_name = "qwinix-learning-validator"
  #   chef.validation_key_path = ".chef/qwinix-learning-validator.pem"
  # end
end
